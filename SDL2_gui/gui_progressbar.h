...
class GUIProgressbar:public GUIComponent{
    ...
    SDL_Renderer *render;
    TTF_Font *font;
    SDL_Texture *texturePercent;
    int percents;
public:
    GUIProgressbar(int x,int y,int w,int h,TTF_Font *font,SDL_Renderer *render,int percents=0,int r=50,int g=50,int b=50,int r1=0,int g1=205,int b1=0);
