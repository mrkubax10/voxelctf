...
class GUICombobox:public GUIComponent{
    ...
    int selectedElement;
    SDL_Texture *textureSelectedElement;
    bool expanded;
    int w2,h2;
...
public:
    GUICombobox(int x,int y,std::vector<std::string> elements,TTF_Font *font,SDL_Renderer *render,int selectedElement=0,int r=255,int g=255,int b=255,int listr=200,int listg=200,int listb=220);
