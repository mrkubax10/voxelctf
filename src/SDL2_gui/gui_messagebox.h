...
public:
    GUIMessagebox(int x,int y,int w,int h,std::string title,TTF_Font *font,SDL_Renderer *render,bool opened=false,bool draggable=true,int r=200,int g=200,int b=200,int borderr=0,int borderg=50,int borderb=255);
